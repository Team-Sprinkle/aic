...
MODE_ENV: dict[str, dict[str, str]] = {
    "nominal": {
        ...
        "AIC_OFFICIAL_TEACHER_SC_TRACKING_GATE_MAX_LATERAL_ERROR_M": "0.0035",
        "AIC_OFFICIAL_TEACHER_CHEATCODE_HANDOFF_SEC": "0.35",
        "AIC_OFFICIAL_TEACHER_CHEATCODE_HANDOFF_SPEED_MPS": "0.06",
        "AIC_OFFICIAL_TEACHER_CHEATCODE_INSERTION_SPEED_MPS": "0.014",
    ...
    "recovery": {
        ...
        "AIC_OFFICIAL_TEACHER_RECOVERY_ALLOW_INITIAL_LOW_FORCE_GATE_MISS_M": "0.0055",
            ...
            for mode in args.modes:
                ...
                for repeat in range(1, args.max_repeats + 1):
                    ...
                    row = {
                        ...
                        "score_threshold": args.score_threshold,
                        "passed": len(result["scores"]) >= args.attempts_per_setting
                        and all(
                            score is not None and float(score) >= args.score_threshold
                            for score in result["scores"][: args.attempts_per_setting]
                        ),
                        "result": result,
                    }
