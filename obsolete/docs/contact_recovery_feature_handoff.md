...
> Archived on 2026-09-17 from `docs/contact_recovery_feature_handoff.md`.
...
> Historical feature handoff. Use [STATUS.md](../../docs/STATUS.md) for current priorities
> and [the ledger](../../docs/EXPERIMENTS.md) for later evidence. The ACT/adapter architecture
> described below is an implemented experiment path under reconsideration.
